...
public class NodePosition {
    ...
    */
    public enum NodeGrid { //.5 meters offset??? from the blue side
      ...
      MID_CENTER(3.5, 0, 0, 152.0, 29.0, 28.0, 29.0, .4), // cl3/21
      MID_RIGHT(17.5, -22, 0, 148.0, 150.75, 43.0, 37.0, -.5),

      HIGH_LEFT(34.0, 22, 0, 148.0, 164, 43.0, 37.0, -.5), //ej3/16
      HIGH_CENTER(19.0, 0, 0, 153.0, 29.0, 38.0, 29.0, 1), //cl3/21
      HIGH_RIGHT(34.0, -22, 0, 148.0, 164, 43.0, 37.0, -.5); //ej 3/16
